...
def main(logdir_or_logfile: str= None, write_pkl: bool= False, write_csv: bool= False, out_dir: str = "./"):
    ...
    """
    logdir_or_logfile = "artifacts/transformer/the_transformer_model/events.out.tfevents.1668840852.JahidsWorkStation.101301.0"
    write_pkl= False
    write_csv = True
    out_dir = "./"
